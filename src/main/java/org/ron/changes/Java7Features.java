...
public class Java7Features {
    ...
    public static final String ROOT = ".\\src\\main\\java\\org\\ron\\changes\\";
    ...
    public void tryWithResources() {
        Utils.printMethod("tryWithResources");
    ...
    public void tryWithResources_betterErrorReporting() {
        Utils.printMethod("tryWithResources_betterErrorReporting");
    ...
    private void stringsInSwitch(String s) {
        Utils.printMethod("stringsInSwitch");
    ...
    private void stringsInSwitch_2(String s) {
        Utils.printMethod("stringsInSwitch_2");
    ...
    private void multipleExceptionHandling() throws IOException, InterruptedException {
        Utils.printMethod("multipleExceptionHandling");

        // this is handy for removing code duplication (better than writing a method)
        // if you do exactly the same processing in 2 or more exception handlers
